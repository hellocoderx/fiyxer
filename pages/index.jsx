    ...
    <Layout>
        ...
        <div className="container-fluid">
          <div className="hero-bottom-image">
            ...
            <div className="hero-social">
              <a target="_blank" href="https://www.facebook.com/Devnextgen.net">
                <i className="fab fa-facebook-f" /> <span>Facebook</span>
              </a>
              <a target="_blank" href="https://twitter.com/DevNextGen.net">
                <i className="fab fa-twitter" /> <span>Twitter</span>
              </a>
              <a target="_blank" href="https://dribbble.com/DevNextGen">
                <i className="fab fa-dribbble" /> <span>Dribbble</span>
              </a>
              <a target="_blank" href="https://www.behance.net/DevNextGen">
            ...
            <div className="col-xl-7 col-lg-9">
              <div className="about-content wow fadeInUp delay-0-4s">
                <div className="section-title mb-40">
                  <span className="sub-title mb-15">About DevNEXTGen</span>
                  <h2>
                ...
                <div className="content">
                  <p>
                    DevNEXTGen is an Agency dedicated to providing high-quality
                    web development, marketing, and UI/UX design services to
                    both local and global clients. Their main goal is to satisfy
                    their clients' needs and exceed their expectations.
                  </p>
              ...
              <div className="what-we-do-content mb-55">
                ...
                <div className="what-we-do-item wow fadeInUp delay-0-3s">
                  ...
                  <div className="content">
                    <h5>UX/UI design</h5>
                    <p>
                      We prioritize user experience (UX) and user interface (UI)
                      design to create seamless interactions.
                    </p>
                ...
                <div className="what-we-do-item wow fadeInUp delay-0-7s">
                  ...
                  <div className="content">
                    ...
                    <p>
                      Our digital marketing strategies are designed to generate
          ...
          <div className="row">
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-three-item wow fadeInUp delay-0-2s">
                ...
                <div className="content">
                  <p>Turn Figma designs into pixel-perfect websites</p>
                  <Link legacyBehavior href="/projects">
                    <a className="read-more style-two">
                      <span>Read More</span>{" "}
                      <i className="far fa-arrow-right" />
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-three-item wow fadeInDown delay-0-2s">
                <div className="title-icon">
                  <h5>
                    <Link legacyBehavior href="/projects">
                      <a>Shopify eCommerce Development</a>
                    </Link>
                  </h5>
                  <img src="assets/images/services/icon2.png" alt="Icon" />
                </div>
                <div className="content">
                  <p>Build powerful and scalable Shopify stores</p>
                  <Link legacyBehavior href="/projects">
                    <a className="read-more style-two">
                      <span>Read More</span>{" "}
                      <i className="far fa-arrow-right" />
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-three-item wow fadeInUp delay-0-2s">
                ...
                <div className="content">
                  <p>Create custom WordPress websites and themes</p>
                  <Link legacyBehavior href="/projects">
                    <a className="read-more style-two">
                      <span>Read More</span>{" "}
                      <i className="far fa-arrow-right" />
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-three-item wow fadeInDown delay-0-2s">
                ...
                <div className="content">
                  <p>Build fast and modern React web applications</p>
                  <Link legacyBehavior href="/projects">
                    <a className="read-more style-two">
                      <span>Read More</span>{" "}
                      <i className="far fa-arrow-right" />
      ...
      <div className="headline-area pt-65 rpt-60 rel z-1">
        <div className="container-fluid">
          <div className="headline-text marquee">
            <span>
              <span>Web Design </span> Solutions
            </span>
          </div>
        </div>
      </div>
          ...
          <div className="row justify-content-between align-items-center pb-25">
            <div className="col-xl-6 col-lg-8">
              <div className="section-title mb-30 wow fadeInLeft delay-0-2s">
                ...
                <h2>
                  Lat’s Look Our Recent Project Gallery / Take a look at our
                  past Projects
                </h2>
              </div>
            </div>
              ...
              <div className="why-choose-two-wrap">
                ...
                <div className="why-choose-item-two wow fadeInUp delay-0-3s">
                  ...
                  <div className="content">
                    <h4>
                      <Link legacyBehavior href="/projects">
                        <a>Best design solutions</a>
                      </Link>
                    </h4>
                    <p>
                      We specialize in creating compelling brand identities that
                ...
                <div className="why-choose-item-two wow fadeInUp delay-0-7s">
                  ...
                  <div className="content">
                    <h4>
                      <Link legacyBehavior href="/projects">
                        <a>Captivate, engage, and deliver</a>
                      </Link>
                    </h4>
                    <p>
                      We specialize in creating compelling brand identities that
