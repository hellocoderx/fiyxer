          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-xl-3 col-lg-4">
              <div className="hero-two-content mb-50 wow fadeInRight delay-0-2s">
                <p>
                  We are a web design and development agency that specializes in
                  creating high-quality, user-friendly websites that help
                  businesses grow. We offer a full range of services, from UX/UI
                  design to content creation to security and performance
                  optimization. We work closely with our clients to create
                  websites that meet their specific needs and go
                </p>
                <img
                  className="mt-20"
            ...
            <div className="col-lg-7 wow fadeInUp delay-0-2s">
              ...
              >
                ...
                <div className="content mt-20">
                  ...
                  <hr />
                  <p>
                    DevNextGen: 170+ Web Development Projects Completed, Trusted
            ...
            <div className="col-lg-5 wow fadeInUp delay-0-4s">
              ...
              >
                ...
                <div className="authors-text">
                  ...
                  <i className="fal fa-plus" />
                  <span className="text">
                    Team of 7+ Expert Developers who are Passionate about
                    creating innovative and effective Web solutions
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section-title text-center mb-60 wow fadeInUp delay-0-2s">
                <h2>Our Expertise In Nextgen Technology</h2>
              </div>
            </div>
          </div>
              ...
              <div className="about-content">
                <div className="section-title mb-40 wow fadeInUp delay-0-2s">
                  <span className="sub-title mb-15">
                    About DevNEXTGen Company
                  </span>
                  <h2>We’re Award-Winning Web Development Agency</h2>
                </div>
                <div className="text-left-border mt-60 mb-65 wow fadeInUp delay-0-2s">
                  <p>
                    DevNextGen is an Award-winning Web Development agency that
                    specializes in creating innovative and effective Web
                    Solutions for Startups, Businesses & Entrepreneurs. With a
                    team of expert developers, we are passionate about helping
                    our clients achieve their business goals through the power
                    of the web.
                  </p>
                </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-7">
              <div className="section-title text-center mb-60 wow fadeInUp delay-0-2s">
                ...
                <h2>We offer the complete Service for your NEXT Web Design</h2>
              </div>
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="service-four-item wow fadeInDown delay-0-2s">
                <div className="content">
                  ...
                  <h5>
                    <Link legacyBehavior href="/service-details">
                      <a>Content Strategy &amp; Consulting</a>
                    </Link>
                  </h5>
                </div>
                <div className="image">
                ...
                <div className="row gap-60">
                  <div className="col-md-6">
                    <div className="why-choose-item wow fadeInUp delay-0-2s">
                      <div className="why-choose-header">
                        ...
                        <h5>In Depth Research</h5>
                      </div>
                      <p>
                        Uncover hidden insights and develop data-driven
                        strategies to inform your digital success.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-6">
                  ...
                  <div className="col-md-6">
                    <div className="why-choose-item wow fadeInUp delay-0-2s">
                      <div className="why-choose-header">
                        <i className="far fa-chevron-right" />
                        <h5>Fast Progressive Development</h5>
                      </div>
                      <p>
                        Deliver high-quality products quickly and efficiently,
                        using agile methodologies and cutting-edge technologies.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="why-choose-item wow fadeInUp delay-0-3s">
                      <div className="why-choose-header">
                        <i className="far fa-chevron-right" />
                        <h5>Extensive User Testing</h5>
                      </div>
                      <p>
                        Ensure your products and services meet the needs of your
                        users through rigorous testing and feedback loops.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
              <div className="section-title text-center mb-60 wow fadeInUp delay-0-2s">
                ...
                <h2>Best Pricing Package For All Web Design Solutions
</h2>
              </div>
            </div>
          </div>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-7 col-lg-9">
              <div className="section-title text-center mb-60 wow fadeInUp delay-0-2s">
                ...
                <h2>Explore our Valuable insights</h2>
              </div>
            </div>
          </div>
          <div className="row">
