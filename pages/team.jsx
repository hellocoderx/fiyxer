            ...
            <div className="col-lg-7">
              <div className="skill-content pt-40 rpt-60 wow fadeInUp delay-0-4s">
                <div className="section-title mb-40">
                  ...
                  <h2>
                    Our Team of Professionals is Here to Help You Achieve Your
                    Goals
                  </h2>
                </div>
                <p>
                  We have a team of experienced and professional experts who are
                  dedicated to helping our clients succeed. With 6+ years of
                  experience and a team of certified professionals, we have the
                  expertise to help you achieve your Startups & Businesses
                  goals.
                </p>
                <TeamSkills />
              </div>
          ...
          <div className="row justify-content-center pb-45 rpb-25">
            <div className="col-xl-7 col-lg-9">
              <div className="section-title text-center wow fadeInUp delay-0-2s">
                <span className="sub-title mb-15">We're Your Partners in Success
</span>
                <h2>Need Help with Your NEXT Project? We're Here to Help!
</h2>
                <Link legacyBehavior href="/contact">
                  <a className="explore-more text-start mt-30">
                    <i className="fas fa-arrow-right" />{" "}
                    <span>Get a Free Quote
</span>
                  </a>
                </Link>
              </div>
