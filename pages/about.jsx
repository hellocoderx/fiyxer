          ...
          <div className="row">
            <div className="col-lg-6 wow fadeInLeft delay-0-2s">
              <div className="client-text text-lg-start text-center mt-40 pb-50">
                <span className="font-bold">Our Story:</span> Founded in 2017,
                our DevNEXTGen agency started as a small team with big dreams.
                We recognized the need for innovative and effective solutions
                that could help businesses thrive in a rapidly evolving digital
                world. With a deep understanding of the power of creativity and
                technology.
              </div>
              <div className="row">
          ...
          <div className="row gap-90">
            <div className="col-lg-4 col-md-6">
              <div className="why-choose-item style-two wow fadeInUp delay-0-2s">
                ...
                <p>
                  We'll start by getting to know you and your business inside
                  and out. We'll learn about your goals, your target audience,
                  and your competition. We'll also conduct a thorough analysis
                  of your existing website (if you have one).
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="why-choose-item style-two wow fadeInUp delay-0-4s">
                ...
                <p>
                  Once we have a good understanding of your needs, we'll start
                  working on a design that is both visually appealing and
                  user-friendly. We'll work closely with you to ensure that the
                  design meets your expectations and that it reflects your brand
                  identity.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="why-choose-item style-two wow fadeInUp delay-0-6s">
                ...
                <p>
                  We'll develop your website quickly and efficiently, using the
                  latest technologies and best practices. We'll also test your
                  website thoroughly before we launch it, to ensure that it is
      ...
      <section className="client-logo-area pt-130 rpt-100 pb-100 rpb-70">
        <div className="container">
          <div className="section-title text-center mb-60">
            <h4>Trusted by World’s leading 350+ Companies</h4>
          </div>
          <div className="client-logo-wrap">
            <Link legacyBehavior href="/contact">
