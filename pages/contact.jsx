            ...
            <div className="col-lg-6">
              <div className="our-location-part rmb-55 wow fadeInUp delay-0-2s">
                ...
                <div className="row gap-80 pb-30">
                  <div className="col-sm-6">
                    <div className="our-location-address mb-40">
                      <h5>Austin, United States</h5>
                      <p>
                      111 Tabago Ct, Austin, TX 78737, USA
                      </p>
                      <a className="mailto" href="info@DevNextGen.net">
                      info@DevNextGen.net
                      </a>
                      <br />
                      <a className="callto" href="callto:+8801786281565">
                        <i className="fas fa-phone" /> +880 1786281565
                      </a>
                    </div>
                  </div>
                  <div className="col-sm-6">
                    <div className="our-location-address mb-40">
                      ...
                      <p>5VXC+55G, Tangail 1900, Dhaka, Bangladesh</p>
                      <a className="mailto" href="mailto:support@gmail.com">
                      info.DevNextGen@gmail.com
                      </a>
                      <br />
                ...
                <div className="social-style-two pt-15">
                  ...
                  <a target="_blank" href="https://www.instagram.com/DevNextGen/">
                    <i className="fab fa-instagram" />
                  </a>
                  <a target="_blank" href="https://www.linkedin.com/company/devnextgen">
